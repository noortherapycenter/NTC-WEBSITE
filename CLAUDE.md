...
- The staff portal is protected by a Netlify edge function (netlify/edge-functions/staff-auth.js): server-side 6-digit PIN (153820), 1-hour unlock cookie, progressive lockout after 5 wrong tries.
